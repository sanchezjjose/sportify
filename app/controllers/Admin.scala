...
//
//
//class Admin @Inject() (val reactiveMongoApi: ReactiveMongoApi)
...
//  )
//
//  def save(teamId: Long, seasonId: Long, isPlayoffGame: String) = isAuthenticatedAsync { user => implicit request =>
...
//  }
//
//  def edit(teamId: Long, gameId: Long) = isAuthenticatedAsync { user => implicit request =>
...
//  }
//
//  def update(teamId: Long, gameId: Long, isPlayoffGame: String) = isAuthenticatedAsync { user => implicit request =>
//   gameForm.bindFromRequest.fold(
//     errors => {
...
//  }
//
//  def delete(teamId: Long, seasonId: Long, gameId: Long) = isAuthenticatedAsync { user => implicit request =>
